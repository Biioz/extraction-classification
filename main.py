...
class DocumentAnalyzer:
    ...
    def classify_document(self, features):
        ...
        id_keywords = ["république", "française", "identité", "nationality", "id", "carte"]
        student_keywords = ["étudiant", "student", "université", "university", "ecole", "school", "ine"]
        loyalty_keywords = ["fidélité", "loyalty", "points", "magasin", "store", "market"]
